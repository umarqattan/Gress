...
private let SQLITE_FILE_NAME = "Gress.sqlite"
...
class CoreDataStackManager {
    ...
    */
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Gress", withExtension: "momd")!
    ...
    */
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        do {
            ...
            error = NSError(domain: "Gress", code: 9999, userInfo: (dict as NSDictionary) as? [NSObject : AnyObject])
